            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body"><div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            <thead>
                                <tr>
                                    <th class="no-print">OrderId</th>
                                    <th class="no-print">Region</th>
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">
                                    <td class="no-print"><?php echo $data->OrderId; ?></td>
                                    <td class="no-print"><?php echo $data->Region; ?></td>
                                    ...
                                    <td class="no-print"><a href="editorders.php?orderid=<?php echo $data->OrderId; ?>"> Edit</a> </td>
                            ...
                            <tbody>
                                ...
                                foreach ($orderItems as $value) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-print"><a href="editorderitems.php?orderitemid=<?php echo $value->Id; ?>">Edit</a></td>
