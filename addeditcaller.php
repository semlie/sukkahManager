...
$address = sprintf('?XDEBUG_SESSION_START=netbeans-xdebug%1$s', ($func == "edit") ? "&func=edit&callerid=" . $callerId : '');
...
$data = !empty($callerId) ? $manager->GetCallerId($callerId) : new caller();
var_dump($data);
?>
